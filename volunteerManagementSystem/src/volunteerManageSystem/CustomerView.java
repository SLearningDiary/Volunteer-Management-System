package volunteerManageSystem;

public class CustomerView {
    private CustomerList customers = new CustomerList(10);

    public CustomerView() {
        Customer cust = new Customer("张三", "男", 25, "12345",
                "zhangsan@qq.com");
    ...
    public void enterMainMenu() {
        ...
        do {
            System.out
                    .println("\n-----------------志愿者报名管理系统-----------------\n");
            System.out.println("                   1、添 加 志 愿 者");
            System.out.println("                   2、修 改 志 愿 者");
            System.out.println("                   3、删 除 志 愿 者");
            System.out.println("                   4、志 愿 者 列 表");
    ...
    private void modifyCustomer() {
        System.out.println("---------------------修改志愿者信息---------------------");

        int index;
        Customer cust;
        for (; ; ) {
            System.out.print("请选择待修改志愿者编号(-1退出)：");
        ...
        if (flag) {
            ...
            System.out.println("----------无法找到指定志愿者,修改失败--------------");
        }
    }
    ...
    private void deleteCustomer() {
        ...
        Customer cust;
        for (; ; ) {
            System.out.print("请选择待删除志愿者编号(-1退出)：");
            index = CMUtility.readInt();
            if (index == -1) {
                return;
            }
        ...
        if (flag) {
            ...
            System.out.println("----------无法找到指定志愿者,删除失败--------------");
        }
    }

    private void listAllCustomers() {
        System.out.println("---------------------------志愿者列表---------------------------");
